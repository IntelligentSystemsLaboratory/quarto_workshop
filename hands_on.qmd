...
- Visual Code has options to use quarto in a better user interface
...
- Example of code running: [https://tailor-uob.github.io/mooc_trustworthy_ai/cha_odm/odm.html](https://tailor-uob.github.io/mooc_trustworthy_ai/cha_odm/odm.html)
